...
import { combinationContext, idContext, symbolsContext, modusContext, unitNameContext } from './idContext';
...
function Index(){
  ...
  const providerSymbolArr = useMemo(( )=> ({symbolArr, setSymbolArr}), [symbolArr,setSymbolArr]);

  const[combinationArray, setCombinationArray] = useState([]);
  const providerCombinationArr = useMemo(( )=> ({combinationArray, setCombinationArray}), [combinationArray, setCombinationArray]);

  const[modus, setModus] = useState('');
  const providerModus = useMemo(( )=> ({modus, setModus}), [modus, setModus]);

  const[unitName, setUnitName] = useState([]);
  const providerUnitName = useMemo(( )=> ({unitName, setUnitName}), [unitName, setUnitName]);
  ...
  return(
      <div className= "Index">
          <Switch>
            <combinationContext.Provider value={{combinationArray, setCombinationArray}}>
           <modusContext.Provider value={{modus,setModus}}>
            ...
            <idContext.Provider value={{value,setValue}}>
                <Route exact path="/Learn2Tap/UserAdministration" component= {Welcome} />
                <Route exact path="/Learn2Tap/Glossary" component= {Glossary} />
                <Route exact path="/Learn2Tap/Register" component= {Register} />
                <Route exact path="/Learn2Tap" component= {Menu} /> 
                <Route exact path="/Learn2Tap/FurtherFunctions" component= {FurtherFunctions} />
                <Route exact path="/Learn2Tap/SingleTapMenu" component= {SingleTapMenu} />
                <Route exact path="/Learn2Tap/DoubleTapMenu" component= {DoubleTapMenu} />
                <Route exact path="/Learn2Tap/TripleTapMenu" component= {TripleTapMenu} />
                <Route exact path="/Learn2Tap/ShiftMenu" component= {ShiftMenu} />
                <Route exact path="/Learn2Tap/SwitchMenu" component= {SwitchMenu} />
                <Route exact path="/Learn2Tap/GamesMenu" component= {Games} />
                <Route exact path="/Learn2Tap/TimeToTap" component= {StreakChallenge} />
                <Route exact path="/Learn2Tap/TapIt5-Times" component= {RepeatFive} />
                 <Route exact path="/Learn2Tap/Coding" component= {Coding} />
                <Route exact path="/Learn2Tap/MenuPracticeUnit" component= {MenuLearningUnit} />
                <Route exact path="/Learn2Tap/MenuPracticeUnit3" component= {MenuLU3Level} />
                <Route exact path="/Learn2Tap/Tutoriel" component= {AEIOUTutoriel} />
                <Route exact path="/Learn2Tap/Practice" component= {AEIOUPractice} />
                <Route exact path="/Learn2Tap/Level" component= {AEIOULevel1} />
                <Route exact path="/Learn2Tap/Statistics" component= {Statistics} />
...
ReactDOM.render(<BrowserRouter> <Index/> </BrowserRouter>, rootElement);
