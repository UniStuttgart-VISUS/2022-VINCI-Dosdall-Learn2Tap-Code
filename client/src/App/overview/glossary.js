   ...
   const[headername, setHeaderName]= useState('Single Tap');
    ...
    function loadOverview(modus, currHeadername){
        ...
        if (this.readyState === 4 && this.status === 200) {
             ...
             for(var i = 0; i<31; i++){
               ...
               if(currSym === ']]'){
                ...
                if(currObj[i].id === 1 ){
                    ...
                    table = table + "<thead> <tr> <th scope=\"col\">ONE FINGER DOWN</th> <th scope=\"col\">SYMBOL</th>"+
                   "        </tr>  </thead> <tbody>";
                   if( currSym !== ""){
                    table = table + "<tr> <td>"+ currCombination + "</td> <td>"+ currSym+"</td> </tr>";
                    console.log(table);

                }}else if(((currObj[i].id > 1 && currObj[i].id <6) || (currObj[i].id > 6 && currObj[i].id <10 ) || (currObj[i].id >10 && currObj[i].id <13 ) 
                || (currObj[i].id >13 && currObj[i].id <15 ) || (currObj[i].id === 14 ) || (currObj[i].id === 16 ) || (currObj[i].id >17 && currObj[i].id <22 )|| (currObj[i].id === 23 ) 
                || (currObj[i].id === 25 ) || (currObj[i].id === 27 )  || (currObj[i].id >28 && currObj[i].id <31 )) && currSym !== ""){
                    if(currSym !== null){
                    table = table + "<tr> <td>" + currCombination + "</td> <td>" +currSym +"</td> </tr>";
                    }
                }else if(currObj[i].id === 6){
                        table = table + " </tbody>  <thead> <tr> <th scope=\"col\">TWO FINGERS TOGETHER</th> <th scope=\"col\"></th>"+
                        "  <th scope=\"col\"></th>    </tr></thead>  <tbody>";
                        if( currSym !== ""){
                          table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";

                }}else if(currObj[i].id === 10 ){
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">TWO FINGERS SKIPPING ONE</th> <th scope=\"col\"></th>"+
               "  <th scope=\"col\"></th>    </tr></thead>  <tbody>"
               if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
            ...
            table = table + " </tbody>  <thead> <tr> <th scope=\"col\">TWO FINGERS SKIPPING TWO</th> <th scope=\"col\"></th>"+
           "  <th scope=\"col\"></th>    </tr></thead>  <tbody>";
           ...
           if( currSym !== ""){
            ...
            table = table + " </tbody>  <thead> <tr> <th scope=\"col\">LOOKES LIKE Y AND W</th> <th scope=\"col\"></th>"+
           "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
           if( currSym !== ""){
            table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
            ...
            table = table +  "  </tbody></table></div></div><div id=\"tableSpace\"></div><div id=\"tableLeft2\"><table class=\"table\"  id=\"tableGlossary\">"+
            "    <thead>  <tr><th scope=\"col\">" + "ONE FINGER UP "+ "</th>  <th scope=\"col\">SYMBOL</th>  </tr> </thead>  <tbody> ";
            if( currSym !== ""){
             table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
                ...
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">ONE FINGER CHASING TWO</th> <th scope=\"col\"></th>"+
            "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
            if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
                ...
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">Two FINGERS CHASING ONE</th> <th scope=\"col\"></th>"+
               "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
               if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
                ...
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">THREE FINGERS SKIPPING TWO</th> <th scope=\"col\"></th>"+
               "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
               if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
                ...
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">THREE FINGERS TOGETHER</th> <th scope=\"col\"></th>"+
               "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
               if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
                ...
                table = table + " </tbody>  <thead> <tr> <th scope=\"col\">ALL FINGERS TOEGEHTER</th> <th scope=\"col\"></th>"+
               "  <th scope=\"col\"></th>    </tr></thead>  <tbody> ";
               if( currSym !== ""){
                table = table + " <tr>  <td>" +currCombination +" </td><td>"+ currSym+ "</td>  </tr>";
        ...
        useEffect(() => {
            const timer = setInterval(() => {
                ...
                if(initialize){
                    ...
                    Axios.get(`http://localhost:3001/getGlossary/${currHand}`,).then((response)=>{
    ...
    return(
        ...
        <div>
            ...
            <div id = "selection">
                    ...
                    <button   class="normalButton" type="button" id="glossaryButtonOverview"   onClick={()=>{
                ...
                {showGlossary &&<div>
                <div> <br></br> <h4 class="tableHeader">{ headername} </h4> <br></br>"</div>
           
           <div id = "showInfo" ></div></div>}
