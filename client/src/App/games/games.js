        ...
        <div>
           ...
           <button class="normalButton" type="button" id="menuButtonSingleTap"
            ...
            <button class="normalButton" type="button" id="glossaryButtonSingleTapMenu"
                onClick={() => {
                  sendUserTracking(value, 'Button click', 'Glossary Button', 'Games Menu' ); 
           ...
           <div class="menuDiv"> 
           <button class="normalButton"  id= "gameButtonGamesMenu" type="button" 
          onClick={() => {
          
            sendUserTracking(value, 'button click', 'Time To Tap Button', 'gamesMenu' ); 
          ...
          ><div>
            <b>Time To Tap</b>
        <br></br>
          All modes available</div>
        </button>

        <button class="normalButton"   id= "gameButtonGamesMenu"  type="button" 
          onClick={() => {
           sendUserTracking(value, 'button click', 'Tap It 5-Times button', 'gamesMenu' ); 
          ...
          ><div>
            <b>Tap It 5-Times</b>
         <br></br>
          Single Tap, DoubleTap, TripleTap, Switch</div>
        </button>
        <button class="normalButton"   id= "gameButtonGamesMenu"  type="button" 
          onClick={() => {
           sendUserTracking(value, 'button click', 'Coding button', 'gamesMenu' ); 
