			...
			<div>
				{this.state.showLetter && (
					<TutorielLetter
						...
						letter={this.state.letterShow}
						combination={this.state.combiShow}
					></TutorielLetter>
				)}
			</div>
		);
