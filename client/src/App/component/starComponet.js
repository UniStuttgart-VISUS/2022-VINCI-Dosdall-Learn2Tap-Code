...
class Star extends React.Component {
    ...
    drawChart(){
        var data1 = [{x: 25, y: 0}, {x: 10, y: 50}, {x: 50, y: 20}, {x: 0, y: 20}, {x:40, y: 50},{x:25, y: 0}];
        var data2 = [{x: 85, y: 0}, {x: 70, y: 50}, {x: 110, y: 20}, {x: 60, y: 20}, {x:100, y: 50},{x:85, y: 0}];
        var data3 =  [{x: 145, y: 0}, {x: 130, y: 50}, {x: 170, y: 20}, {x: 120, y: 20}, {x:160, y: 50},{x:145, y: 0}];


        const svg = d3.select("#starSVG")
                .attr("width", 200)
                .attr("height", 50)
