...
class Barchart extends React.Component {
    ...
    drawChart(){
        ...
        let barWidth = (this.props.svgWidth/this.props.dataset.length )- this.props.barPadding -(25/this.props.dataset.length);
        ...
        let svg = d3.select("#chart")
                    ...
                    svg.selectAll('text')
                        ...
                        .attr("x", (d,i) => this.props.barPadding + 35 + i*( this.props.barPadding + barWidth ))
 ...
 var yAxisTranslate =  (this.props.svgHeight ) ;//d3.max(this.props.dataset)) - 15;
    svg.append("g")
        ...
        svg.selectAll('rect')
           ...
           .append('rect')
           .attr('x', (d, i) =>  this.props.barPadding + 25 + i*(barWidth +  this.props.barPadding))
           .attr('y', d => (this.props.svgHeight-16) -yScale(d)) 
           .attr('width',barWidth - this.props.barPadding)
           .attr('height', d => yScale(d) )
           .attr('fill', function(){ timeI ++; return(colorArr[timeI])}); 
