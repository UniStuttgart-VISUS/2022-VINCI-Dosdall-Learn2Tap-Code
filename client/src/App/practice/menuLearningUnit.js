  ...
  useEffect(() => {
      ...
      const timer = setInterval(() => {
        ...
        if(count === 0){
         ...
         // var currStat = clearCookie(Cookies.get('statistic'));
       ...
       //  x
        var currSymbolID = clearCookie(Cookies.get('symbolID'));
          ...
          console.log('DEBUG 1', clearCookie(Cookies.get('symbolArrCookie')));
      ...
      <div id="returnMenuDiv">
        ...
        <div width="100%"  class="row">
             ...
             <button class="normalButton" type="button" id="menuButtonSingleTap"
                  onClick={() => {
                    sendUserTracking(value, 'button click', 'Menu Button', 'menu Learning Units' );  
              ...
              <button class="normalButton" type="button" id="glossaryButtonSingleTapMenu"
                  onClick={() => {
                    sendUserTracking(value, 'Button click', 'Glossary Button', 'menu Learning Units' ); 
          ...
          onClick={() => {
            sendUserTracking(value, 'button click', 'Tutoriel Button', 'menu Learning Units' );  
        ...
        <button class="normalButton" type="button" id="practiceButtonMLU"
          onClick={() => {
            sendUserTracking(value, 'button click', 'Practice Button', 'menu Learning Units' );  
        ...
        <button class="normalButton" type="button" id="levelButton"
          onClick={() => {
            sendUserTracking(value, 'button click', 'Level 1 Button', 'menu Learning Units' );  
            Cookies.set("level",1);  
          ...
          > <div class="row">
           ...
           <button class="normalButton" type="button" id="levelButton"
          onClick={() => {
            sendUserTracking(value, 'button click', 'Level 2 Button', 'menu Learning Units' );  
            Cookies.set("level",2);  
            Cookies.set("levelExist",2);  
            window.location.href=  '/Learn2Tap/Level'; }
          }
