...
export const AEIOUPractice = (props) => {
	...
	function useKeyPress() {
		...
		function downHandler({ key }) {
			...
			} else if (symbolArr.indexOf(key) !== -1 && typingMode === "singleTap") {
				setKeyPressed(true);
			...
			if (rounds === 2) {
				...
				if (userTrackinEndSend) {
					sendUserTracking(
						value,
						"All Key Pressed",
						"Pressed:" + allKeyPressed,
						"Finish Practice - " + unitName + ""
					);
	...
	return (
		<div id="returnMenuDiv">
			<div>
				...
				{showLetterColor && (
					<div id="last">Last Tapped Combination: {lastKey}</div>
				)}
