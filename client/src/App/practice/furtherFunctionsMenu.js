...
export const FurtherFunctions = props => {
  ...
  const[keys, setKeys] = useState(['switch + ⬤ ○⬤○○','switch + ○ ⬤⬤○○','switch + ⬤ ⬤○○○','switch + ○ ○⬤⬤○','switch + ⬤ ○○⬤○','switch + ⬤ ○⬤⬤○', 'switch + ⬤ ⬤○⬤⬤', 'switch + ○ ⬤⬤⬤○' , 'switch + ⬤ ⬤○○⬤'])
  ...
  function loadMarking(){
    ...
    if(rightHand === false){
      setKeys(['switch + ○○⬤○ ⬤','switch + ○○⬤⬤ ○','switch + ○○○⬤ ⬤','switch + ○⬤⬤○ ○','switch + ○⬤○○ ⬤','switch + ○⬤⬤○ ⬤', 'switch + ⬤⬤○⬤ ⬤', 'switch + ○⬤⬤⬤ ○', 'switch + ⬤○○⬤ ⬤' ])
     }
  ...
  useEffect(() => {
      const timer = setInterval(() => {
          ...
          if(initialize){
            sendUserTracking(value, 'Open Further Functions','Further Functions', 'Further Functions' ); 
      ...
      return(
        <div id="returnMenuDiv">
          <div>
              ...
              <button class="normalButton" type="button" id="menuButtonSingleTap"
                    onClick={() => {
                      sendUserTracking(value, 'button click', 'Menu Button', 'Further Functions Menu' );  
              ...
              {showSelection && <div class="showSelectionDiv"> 
              <button class="normalButton" id="practicButtonMenuFF" type="button" 
            onClick={() => {
        ...
        <button class="normalButton" id="practicButtonMenuFF" type="button" 
            ...
            ><div>
              ...
              {showAddSpace && <div>
                  ...
                  {explainThree}
                  <br></br>
                  <button class="normalButton" id="practicButtonMenuFFX" type="button" 
            onClick={() => {
        ...
        {explainMarking && <div>
          ...
          <br></br>
              Use the arrow keys to select which parts of the text should be selected 
              <br></br>(Up: {keys[1]}, left: {keys[2]}, right: {keys[3]}, down: {keys[4]}).
              <br></br>
          ...
          {example && <div><br></br>
            ...
            {sentenceToTap}
              <br></br>
              <br></br>
            <textarea name="Text1" cols="40" rows="5"></textarea> </div>}
              {explainMarking &&
              <textarea name="Text1" cols="40" rows="5">	(1 to: 10)
               do: [ :i | 
