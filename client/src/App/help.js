			...
			<div>
				...
				<div className="modeSelection">
					<div id="hintsDiv">
						...
						<ul>
							<li>
								Set your keyboard to <b>US-keyboard</b> so that TapStrap works
								without problems.
							</li>
							<li>
								<b>Disable </b>your <b>browser's shortcuts </b>to use TapStrap
								Shift-Mode without problems.
							</li>
							<li>
								Make sure that your TapStrap uses the <b>correct mapping</b>{" "}
								(Mapping to programme in AVAR).
							</li>
							<li>
								Make sure your TapStrap is in the <b>correct mode.</b> (Default,
								Switch, Shift --> always in default mode when Escape is pressed)
							</li>
