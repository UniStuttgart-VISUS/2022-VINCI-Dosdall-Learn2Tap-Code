...
app.post('/userTracking',(req,res) =>{
    ...
    if(id != -1){
    dbUser.query('INSERT INTO usertracking (userID, event, eventName, location) VALUES(?,?,?,?)', [id, event, eventName, location], (err,result)=>{
...
app.get('/getSingleTabMenu', (req, res)=>{
    ...
    dbUser.query('SELECT nameModus,singletap FROM overviewmenu', (err, result) =>{
    ...
    dbUser.query('SELECT id, righthand, lefthand, single FROM levels', (err, result) =>{
        if(err){
            ...
            for(var i = 0; i< resultJson.length; i++){
                ...
                if(symbolIds.includes(resultJson[i].id) && resultJson[i].id >= smallestNum){
           ...
           const keys = Object.keys(resultJson);
                ...
                keys.forEach((key, index) => {
                    ...
                    if(resultJson[key] != 0){
                        ...
                        resultJson[key] = (resultJson[key] + (2 * resultStat[letter.indexOf(key)]))/3;
                    }else{
                ...
                dbUser.query('UPDATE singletab SET a=?, b=?, c=?, d=?, e=?, f=?, g=?, h=?, i=?, j=?, k=?, l=?, m=?, n=?, o=?, p=?, q=?, r=?, s=?, t=?, u=?, v=?, w=?, x=?, y=?, z=?, Enter = ?, Backspace = ? WHERE userID = ?',
                [update[0],update[1], update[2],update[3], update[4],update[5], update[6],update[7], update[8],update[9], update[10],update[11],update[12],update[13], update[14],update[15], update[16],update[17], update[18],update[19], update[20],update[21], update[22],update[23], update[24],update[25],update[26],update[27] ,id], (err, result) =>{
                    if(err){
                        console.log(err);
                    }else{
                        console.log('success');
            ...
            const keys = Object.keys(resultJsonStars);
                 ...
                 keys.forEach((key, index) => {
                     ...
                     if(resultJsonStars[key] < stars){
                            ...
                            dbUser.query('UPDATE singletabstars SET U1_L1=?, U1_L2=?, U2_L1=?,  U2_L2=?,  U2_L3=?, U3_L1=?, U3_L2=?, U3_L3=?, U4_L1=?, U4_L2=?, U4_L3=?, U5_L1=?, U5_L2=?, U5_L3=?, U6_L1=?, U6_L2=?, U6_L3=?, U7_L1=?, U7_L2=?, U7_L3=?, U8_L1=?, U8_L2=?, U8_L3=?, U9_L1=?, U9_L2=?, U9_L3=?  WHERE id = ?',
                            [updateStars[0],updateStars[1], updateStars[2],updateStars[3], updateStars[4],updateStars[5], updateStars[6],updateStars[7], updateStars[8],updateStars[9], updateStars[10],updateStars[11],updateStars[12],updateStars[13], updateStars[14],updateStars[15], updateStars[16],updateStars[17], updateStars[18],updateStars[19], updateStars[20],updateStars[21], updateStars[22],updateStars[23], updateStars[24],updateStars[25], id], (err, result) =>{
                                if(err){
                                    console.log(err);
                                }else{
                                    console.log('success');
...
app.get('/getDoubleTapStar/:userID', (req, res)=>{
  ...
  dbUser.query('SELECT * FROM doubletapstars WHERE userID=?', id, (err, result) =>{
    if(err){
        console.log(err);
    }else{
        const resultJson = Object.values(JSON.parse(JSON.stringify(result)))[0];
...
app.get('/getSymbolArrayDoubleTap/:symbolIds/:rightHand/:value', (req, res)=>{
                ...
                const rightHand = req.params.rightHand;
                const userID = req.params.value;
                var symbolIdsDouble = [3,4,5,7,8,9,10,11,13,14,15,17,18,19,21,22,23,26,27,31];
            
              
            
                dbUser.query('SELECT id, righthand, lefthand, doubletap, doublekeycombi FROM levels', (err, result) =>{
                    if(err){
                        console.log(err);
                    }else{
                        ...
                        for(var i = 0; i< resultJson.length; i++){
                            if(resultJson[i].id<smallestNum && symbolIdsDouble.includes(resultJson[i].id)){
                            ...
                            if(symbolIds.includes(resultJson[i].id) && resultJson[i].id >= smallestNum && symbolIdsDouble.includes(resultJson[i].id)){
                ...
                const keys = Object.keys(resultJsonStars);
                     ...
                     keys.forEach((key, index) => {
                         ...
                         if(resultJsonStars[key] < stars){
                                ...
                                dbUser.query('UPDATE doubletapstars SET U1_L1=?, U1_L2=?, U2_L1=?,  U2_L2=?,  U2_L3=?, U3_L1=?, U3_L2=?, U3_L3=?, U4_L1=?, U4_L2=?, U4_L3=?, U5_L1=?, U5_L2=?, U5_L3=?, U6_L1=?, U6_L2=?, U6_L3=?  WHERE userID = ?',
                                [updateStars[0],updateStars[1], updateStars[2],updateStars[3], updateStars[4],updateStars[5], updateStars[6],updateStars[7], updateStars[8],updateStars[9], updateStars[10],updateStars[11],updateStars[12],updateStars[13], updateStars[14],updateStars[15], updateStars[16], id], (err, result) =>{
                                    if(err){
                                        console.log(err);
                                    }else{
                                        console.log('success');
...
app.get('/getTripleTabMenu', (req, res)=>{
    ...
    dbUser.query('SELECT nameModus,tripletap FROM overviewmenu', (err, result) =>{
...
app.get('/getTripleTapStar/:userID', (req, res)=>{
  ...
  dbUser.query('SELECT * FROM tripletapstars WHERE userID=?', id, (err, result) =>{
    if(err){
        console.log(err);
    }else{
        const resultJson = Object.values(JSON.parse(JSON.stringify(result)))[0];
    ...
    dbUser.query('SELECT id, righthand, lefthand, triple, triplekeycombi  FROM levels', (err, result) =>{
        if(err){
            ...
            for(var i = 0; i< resultJson.length; i++){
                ...
                if(resultJson[i].id<smallestNum && symbolIdsTriple.includes(resultJson[i].id)){
                ...
                if(symbolIds.includes(resultJson[i].id) && resultJson[i].id >= smallestNum && symbolIdsTriple.includes(resultJson[i].id)){
            ...
            const keys = Object.keys(resultJsonStars);
                 ...
                 keys.forEach((key, index) => {
                     ...
                     if(resultJsonStars[key] < stars){
                            ...
                            dbUser.query('UPDATE tripletapstars SET U1_L1=?, U1_L2=?, U2_L1=?,  U2_L2=?,  U2_L3=?, U3_L1=?, U3_L2=?, U3_L3=?, U4_L1=?, U4_L2=?, U4_L3=?  WHERE userID = ?',
                            [updateStars[0],updateStars[1], updateStars[2],updateStars[3], updateStars[4],updateStars[5], updateStars[6],updateStars[7], updateStars[8],updateStars[9], updateStars[10],updateStars[11], id], (err, result) =>{
                                if(err){
                                    console.log(err);
                                }else{
                                    console.log('success');
...
app.get('/getAllStatisticTriple/:value',(req, res) =>{
    ...
    const id  = req.params.value;
    var symbolIdsTriple = [5,7,8,10,11,13,14,15,18,19,21,22,23,26,27];
        ...
        if(err){
            ...
            for(var i = 0; i< resultJson.length; i++){
                ...
                if(resultJson[i].id<smallestNum && symbolIdsShift.includes(resultJson[i].id)){
                    ...
                    if(rightHand === "true"){
                        allCombinationArray.push('ShiftMode +' +  " " +resultJson[i].righthand);
    
                    }else{
                        allCombinationArray.push('ShiftMode +' +  " " +resultJson[i].lefthand);
                    }
                }

                if(symbolIds.includes(resultJson[i].id) && resultJson[i].id >= smallestNum && symbolIdsShift.includes(resultJson[i].id)){
                   ...
                   symbolArray.push(resultJson[i].shift);
                    ...
                    allSymbolArray.push(resultJson[i].shift);
                if(rightHand === "true"){
                    combinationArray.push('ShiftMode +' +  " " +resultJson[i].righthand);
                    allCombinationArray.push('ShiftMode +' +  " " +resultJson[i].righthand);

                }else{
                    combinationArray.push('ShiftMode +' +  " " +resultJson[i].lefthand);
                    allCombinationArray.push('ShiftMode +' +  " " +resultJson[i].lefthand);
                }
            }
        }
            ...
            const keys = Object.keys(resultJsonStars);
                 ...
                 keys.forEach((key, index) => {
                     ...
                     if(resultJsonStars[key] < stars){
                            ...
                            dbUser.query('UPDATE shiftstars SET U1_L1=?, U1_L2=?, U2_L1=?,  U2_L2=?,  U2_L3=?, U3_L1=?, U3_L2=?, U3_L3=?, U4_L1=?, U4_L2=?, U4_L3=?, U5_L1=?, U5_L2=?, U5_L3=?, U6_L1=?, U6_L2=?, U6_L3=? ,  U7_L1=?, U7_L2=?, U7_L3=?,  U8_L1=?, U8_L2=?, U8_L3=? WHERE userID = ?',
                            [updateStars[0],updateStars[1], updateStars[2],updateStars[3], updateStars[4],updateStars[5], updateStars[6],updateStars[7], updateStars[8],updateStars[9], updateStars[10],updateStars[11],updateStars[12],updateStars[13], updateStars[14],updateStars[15], updateStars[16], updateStars[17],updateStars[18], updateStars[19], updateStars[20],updateStars[21], updateStars[22], id], (err, result) =>{
                                if(err){
                                    console.log(err);
                                }else{
                                    console.log('success');
...
app.get('/getSwitchStar/:userID', (req, res)=>{
  ...
  dbUser.query('SELECT * FROM switchstars WHERE userID=?', id, (err, result) =>{
    if(err){
        console.log(err);
    }else{
        const resultJson = Object.values(JSON.parse(JSON.stringify(result)))[0];
...
app.get('/getSymbolArraySwitch/:symbolIds/:rightHand/:value', (req, res)=>{
    ...
    const rightHand = req.params.rightHand;
    const userID = req.params.value;
    var symbolIdsSwitch = [1,2,3,4,5,6,7,8,9,15,14,12,13,17,19,21,22,23,24,26,27,29];

 
    dbUser.query('SELECT id, righthand, lefthand, switch, switchkeycombi FROM levels', (err, result) =>{
        if(err){
            console.log(err);
        }else{
            ...
            for(var i = 0; i< resultJson.length; i++){
                ...
                if(resultJson[i].id<smallestNum && symbolIdsSwitch.includes(resultJson[i].id)){
                    ...
                    if(rightHand ==="true"){
                        allCombinationArray.push('SwitchMode +' +  " " + resultJson[i].righthand);
    
                    }else{
                        allCombinationArray.push('SwitchMode +' + " " + resultJson[i].lefthand);
                    }
                }

                if(symbolIds.includes(resultJson[i].id) && resultJson[i].id >= smallestNum && symbolIdsSwitch.includes(resultJson[i].id)){
                   ...
                   symbolArray.push(resultJson[i].switch);
                    allSymbolArray.push(resultJson[i].switch);
                if(rightHand ==='true'){
                    combinationArray.push('SwitchMode +'+ " " + resultJson[i].righthand);
                    allCombinationArray.push('SwitchMode +' +  " " +resultJson[i].righthand);

                }else{
                    combinationArray.push('SwitchMode +' + " " + resultJson[i].lefthand);
                    allCombinationArray.push('SwitchMode +' +  " " + resultJson[i].lefthand);
                }
            }
        }
        console.log(allSymbolArray);

            res.send([symbolArray, combinationArray, allSymbolArray, allCombinationArray, keyCombi, allKeyCombis]);
       ...
       dbUser.query('SELECT * FROM switch WHERE userID=?',  id , (err, result) =>{
        if(err){
           ...
           var valSids = [];
                ...
                dbUser.query('UPDATE switch SET sid_1=?, sid_2=?, sid_3=?, sid_4=?, sid_5=?,sid_6=?, sid_7=?,sid_8=?, sid_9=?, sid_15=?, sid_14=?, sid_12=?, sid_13=?, sid_17=?, sid_19=?, sid_21=?, sid_22=?, sid_23=?, sid_24=?, sid_26=?,sid_27=?, sid_29=? WHERE userID = ?',
                [valSids[0],valSids[1], valSids[2],valSids[3], valSids[4], valSids[5], valSids[6], valSids[7], valSids[8],valSids[9], valSids[10],valSids[11],valSids[12],valSids[13], valSids[14],valSids[15], valSids[16],valSids[17] , valSids[18] ,valSids[19] ,valSids[20] ,valSids[21]  ,id], (err, result) =>{
                    if(err){
                        console.log(err);
                    }else{
            ...
            const keys = Object.keys(resultJsonStars);
                 ...
                 keys.forEach((key, index) => {
                     ...
                     if(resultJsonStars[key] < stars){
                            ...
                            dbUser.query('UPDATE switchstars SET U1_L1=?, U1_L2=?, U2_L1=?,  U2_L2=?,  U2_L3=?, U3_L1=?, U3_L2=?, U3_L3=?, U4_L1=?, U4_L2=?, U4_L3=?, U5_L1=?, U5_L2=?, U5_L3=?, U6_L1=?, U6_L2=?, U6_L3=?  WHERE userID = ?',
                            [updateStars[0],updateStars[1], updateStars[2],updateStars[3], updateStars[4],updateStars[5], updateStars[6],updateStars[7], updateStars[8],updateStars[9], updateStars[10],updateStars[11],updateStars[12],updateStars[13], updateStars[14],updateStars[15], updateStars[16],  id], (err, result) =>{
                                if(err){
                                    console.log(err);
                                }else{
        ...
        dbUser.query('SELECT * FROM timetohitscore WHERE userID= ?',id, (err, result) =>{
            if(err){
               ...
               const keys = Object.keys(resultJson);
                ...
                var statRes = [];
                var recorde = (resultJson['recordeHit']+ resultJson['recordeAccuracy'])/2;
                statRes.push(recorde);
                keys.forEach((key, index) => {
                    if(key !== 'userID' && key !=='recordeHit'&& key !== 'recordeAccuracy'){
                   ...
                   keys.forEach((key, index) => {
                    ...
                    var nextVal = 0;
                       ...
                       if(insertArr[1]< accuracy){
                        ...
                        dbUser.query('UPDATE fivetimes SET recordeScore=?, recordeAccuracy = ?, G1=?, G2=?, G3=?, G4=?, G5=?, G6=?, G7=?, G8=?, G9=?, G10=?, G11=?, G12=?, G13=?, G14=?, G15=?, G16=?, G17=?, G18=?, G19=?, G20=? WHERE userID = ?',
                        [insertArr[0],insertArr[1],insertArr[2],insertArr[3],insertArr[4],insertArr[5],insertArr[6],insertArr[7],insertArr[8],insertArr[9],insertArr[10],insertArr[11],insertArr[12],insertArr[13],insertArr[14],insertArr[15],insertArr[16],insertArr[17],insertArr[18],insertArr[19],insertArr[20],insertArr[21],id], (err, result) =>{
                            if(err){
                                console.log(err);
                            }else{
                ...
                dbUser.query('SELECT * FROM fivetimes WHERE userID= ?',id, (err, result) =>{
                    if(err){
                       ...
                       const keys = Object.keys(resultJson);
                        ...
                        statRes.push(recorde);
                        keys.forEach((key, index) => {
                            if(key !== 'userID' && key!=='recordeScore' && key !== 'recordeAccuracy'){
                                statRes.push(resultJson[key]);
...
app.get('/getFiveTimesWords',(req, res) =>{
 ...
 app.get('/getCodingRecords/:value',(req, res) =>{
    ...
    const id  = req.params.value;
        ...
        dbUser.query('SELECT recordeScore, recordeAccuracy FROM codinggame WHERE userID=?', id,(err, result) =>{
            if(err){
                console.log(err);
               }else{
